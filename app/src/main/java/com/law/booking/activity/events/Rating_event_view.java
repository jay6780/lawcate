...
public class Rating_event_view extends AppCompatActivity {
    ...
    private String TAG = "Rating_event_view";
    ...
    private void fetchServices() {
        serviceRef = FirebaseDatabase.getInstance().getReference("EventOrg").child(currentUserId);
    ...
    private void setupBanner(List<Service> services) {
        if (Rating_event_view.this != null) {
            DisplayMetrics displayMetrics = new DisplayMetrics();
            Rating_event_view.this.getWindowManager().getDefaultDisplay().getMetrics(displayMetrics);
            int screenWidth = displayMetrics.widthPixels;
            int heightInPixels = Utils.dp2px(Rating_event_view.this, 300);
            LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(screenWidth, heightInPixels);
            banner.setLayoutParams(lp);
            banner.setAdapter(new coverAdapter(services, Rating_event_view.this))
                    .setIndicator(new CircleIndicator(Rating_event_view.this))
