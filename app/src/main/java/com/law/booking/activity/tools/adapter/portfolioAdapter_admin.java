...
import com.law.booking.activity.MainPageActivity.Provider.FullScreenImageActivity3;
...
public class portfolioAdapter_admin extends RecyclerView.Adapter<portfolioAdapter_admin.ServiceViewHolder> {
    private List<Service> serviceList;
    private Context context;
    public portfolioAdapter_admin(List<Service> serviceList, Context context) {
                ...
                pictureref.orderByChild("caption").equalTo(service.getCaption()).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (!imageUrls.isEmpty()) {
                            Intent intent = new Intent(view.getContext(), FullScreenImageActivity3.class);
